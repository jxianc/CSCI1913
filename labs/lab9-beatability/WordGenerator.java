/**
 * A WordGenerator represents a list of words.
 * Words will be randomly generated from this list
 * For testing, this uses RNGUtilities
 */
public class WordGenerator implements RandomGenerator<String> {

    @Override
    public String get() {
        int index = RNGUtilities.nextInt(0, words.length);
        return words[index];
    }
